<?php
  ...
  include("../datosUsuario.php"); 
   ...
   $sql = "SELECT 
               confGrupoContable.Nombre AS Producto, 
               SUM(activos.ValorRazonable) AS Cantidad
         FROM 
            activos  
            LEFT JOIN confGrupoContable ON confGrupoContable.id = activos.idGrupo 
         $where
         GROUP BY 
            confGrupoContable.id
         ORDER BY confGrupoContable.Nombre DESC ;";
